...
<head>
    ...
    <title>صفحه مدیریت فروشگاه اینترنتی </title>
...
<div class="wrapper">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="hidden-xs">آرش نریمانی</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2015-2019 <a href="https://www.google.com">arash</a>.</strong>arash
        narimani
    </footer>
