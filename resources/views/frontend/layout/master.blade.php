                    ...
                    <div class="pull-left flip left-top">
                        <div class="links">
                            <ul>
                                ...
                                <li class="email"><a href="mailto:info@marketshop.com"><i class="fa fa-envelope"></i>support@roxo.ir</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="contact col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <h5>درباره روکسو</h5>
                        <p>قالب HTML فروشگاهی روکسو. این یک بلاک مدیریت محتواست. شما میتوانید هر نوع محتوای html نوشتاری یا تصویری را در آن قرار دهید.</p>
                    </div>
